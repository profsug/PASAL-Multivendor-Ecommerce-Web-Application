  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="update_delivery" enctype="multipart/form-data" method="post">
...
<script>
	function change_delivery_status(status, order_id){    		
  ...
  $("#update_delivery").submit(function(event)
    ...
    $.ajax({
      ...
      type:'POST',
      data:{change_delivery:1, order_id : order_id  ,  delivery_status:delivery_status}, 
