...
<div class="banner-top">
	<div class="container">
		<h3 >FAQ</h3>
		<h4><a href="index.php">Home</a><label>/</label>FAQ</h4>
				...
				<!-- First Panel -->
					<div class="panel panel-default">
						...
						<div id="collapseOne" class="panel-collapse collapse">
							<div class="panel-body">
								<p>The delivery charge is Rs.100 inside ring road and Rs.150 outside ring road</p>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-default">
						...
						<div id="collapseTwo" class="panel-collapse collapse">
							<div class="panel-body">								
								<p>Your order will be delivered within the same day</p>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-default">
						...
						<div id="collapseThree" class="panel-collapse collapse">
							<div class="panel-body">
								<p>The estimated delivery time is 4-5 hours</p>
							</div>
						</div>
					</div>
					<!-- Fourth Panel -->
					<div class="panel panel-default">
						...
						<div id="collapseFour" class="panel-collapse collapse">
							<div class="panel-body">
								<p>No, currently we only deliver inside kathmandu</p>
							</div>
						</div>
					</div>
					<!-- Fifth Panel -->
					<div class="panel panel-default">
						<div class="panel-heading">
							 <h4 class="panel-title" data-toggle="collapse" data-target="#collapseFive">
								<span>5.</span>How do I take advantage of Free Delivery?
							 </h4>
						</div>
						<div id="collapseFive" class="panel-collapse collapse">
							<div class="panel-body">
								<p>You can enjoy free delivery on purchase of Rs.1000 and above</p>
							</div>
						</div>
					</div>
					<!-- Sixth Panel -->
					<div class="panel panel-default">
						<div class="panel-heading">
							 <h4 class="panel-title" data-toggle="collapse" data-target="#collapseSix">
								<span>6.</span>How can I place pre-order?
							 </h4>
						</div>
						<div id="collapseSix" class="panel-collapse collapse">
							<div class="panel-body">
								<p> You can select pre-order option in checkout page </p>
							</div>
						</div>
					</div>
