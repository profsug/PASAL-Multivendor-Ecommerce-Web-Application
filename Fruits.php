    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="images/caro1.jpg" alt="First slide"></a>
       
        </div>
        <div class="item">
         <img class="second-slide " src="images/caro2.jpg" alt="Second slide"></a>
         
        </div>
        <div class="item">
           <img class="third-slide " src="images/caro3.jpg" alt="Third slide"></a>
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">								
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											<p><em class="item_price"> Rs <?php echo $res2['product_price'];?></em></p>
											<br><p>Grade: <?php echo $res2['grade_title']; ?></p>
											<br><p>Vendor: Vendor1</p>
										...
										<div class="add">
										   ...
										   data-name= "<?php echo $res2['product_title'];?>"data-summary="summary 1" data-price="<?php echo $res2['product_price'];?>" data-quantity="1" 
